...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'border-input bg-background flex w-full items-center justify-between gap-2 rounded-md border px-3 py-2 shadow-xs',
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-pointer items-center gap-2 rounded-sm py-2 ps-2 pe-8 text-sm outline-hidden select-none',
