  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          'bg-background pointer-events-none block size-5 rounded-full ring-0 transition-transform',
          // Transforms are physical, so the travel direction is mirrored for RTL.
