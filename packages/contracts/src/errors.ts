...
export const ERROR_CODES = {
  ...
  SLOT_LABEL_TAKEN: 'SLOT_LABEL_TAKEN',
  ...
  COMPONENT_EXCEEDS_LIMIT: 'COMPONENT_EXCEEDS_LIMIT',
...
export const ERROR_MESSAGES_AR: Record<ErrorCode, string> = {
  ...
  SLOT_HAS_BOOKINGS: 'لا يمكن حذف فترة عليها حجوزات. أغلقها بدلًا من ذلك.',
  SLOT_LABEL_TAKEN: 'يوجد فترة بنفس الاسم بالفعل.',
  ...
  COMPONENT_OUT_OF_STOCK: 'الكمية المطلوبة غير متوفرة من هذا المكوّن في هذه الفترة.',
  COMPONENT_EXCEEDS_LIMIT: 'تجاوزت الحد المسموح لكل مجموعة من هذا المكوّن.',
  ...
  TOTAL_BELOW_RESERVED: 'لا يمكن تقليل الكمية لأقل من المطلوب في فترة قادمة.',
